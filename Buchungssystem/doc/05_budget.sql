...
create table ZYKLUS (
	...
	TAGE Bit(7),
	UNTERBRUCH Integer,
	INTERVALL_ID_FS Integer NOT NULL,
	FOREIGN KEY (INTERVALL_ID_FS) REFERENCES INTERVALL(INTERVALL_ID)
);
...
create table DAUERAUFTRAG (
	...
	END_DATUM DATE,
	TYP_ID_FS Integer NOT NULL,
	ZYKLUS_ID_FS Integer NOT NULL,
	PERSON_ID_FS Integer NOT NULL,
	FOREIGN KEY (TYP_ID_FS) REFERENCES TYP(TYP_ID),
	FOREIGN KEY (ZYKLUS_ID_FS) REFERENCES ZYKLUS(ZYKLUS_ID),
	FOREIGN KEY (PERSON_ID_FS) REFERENCES PERSON(PERSON_ID)
